...
describe("AccountInformation", () => {
  ...
  it("should render all fields", async () => {
    ...
    expect(screen.getByText("form.page.3.field.1")).toBeInTheDocument();
    expect(screen.getByText("form.page.3.field.2")).toBeInTheDocument();
    expect(screen.getByText("form.page.3.field.3")).toBeInTheDocument();
  });
  //   render(
  //     <>
  //       <AccountInformation />
